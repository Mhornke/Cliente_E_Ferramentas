...
export default function Comentarios() {
  ...
  }, [params.ferramenta_id, ferramenta])
      ...
      <div className="mr-4 ml-4">
        {caixaDeComentarios ? (
          <div className="border w-full h-[10rem] flex justify-center place-items-center bg-green-200 ">
            <Image src="/marca-de-verificacao.png" alt="checkbox" className="w-10" />
          ...
          <>
            ...
            <form onSubmit={handleSubmit(enviaAvaliacao)}>
              ...
              <h3 className="mb-2 mt-4 bg-gray-100 border 
               text-gray-900 text-sm rounded-lg
                focus:ring-blue-500 focus:border-blue-500 
                block w-full p-2.5 cursor-not-allowed ">{cliente.nome}</h3>
              <textarea
                id="message"
